    ...
    <div className="mx-auto max-w-screen-lg pt-0 pb-6">
      ...
      <div className="section-text">
        <p>
          ...
          <Color>senior backend software engineer</Color>, +{yearsSince(2014)}
          yrs as <Color>tech lead</Color> with <Color>management</Color>{' '}
          experience, do speeches/coordinate events, 2 times dad (two boy,{' '}
          {yearsSince(2018)} and {yearsSince(2025)} yrs). I am a very pragmatic
        ...
        <p>
          Do you think I can help you to grow in your career (
          <Color>mentoring</Color>)? Would you like to <Color>hire me</Color>?
          Please schedule a time with me{' '}
          <Link
            className="underline"
            href="https://calendly.com/adamatti"
            target="_blank"
          >
            here
          </Link>
      ...
      <div className="mt-3 flex justify-center gap-1">
        ...
        <SocialLink
          href="http://www.linkedin.com/in/adamatti"
          icon="linkedin"
        />
